...
class Grasp_anyting(Dataset):
    ...
    # read json
    input_file = "/inspurfs/group/mayuexin/datasets/graspall_datasets/grasp_168w.json"
    ...
    def __init__(self, cfg: DictConfig, phase: str, slurm: bool, case_only: bool=False, **kwargs: Dict) -> None:
        ...
        self.data_dir = os.path.join('/inspurfs/group/mayuexin/datasets/graspall_datasets/')
        self.scene_path = os.path.join('/inspurfs/group/mayuexin/datasets/grasp_anyting', 'object_pcds_nors.pkl')
    ...
    def _pre_load_data(self, case_only: bool) -> None:
        ...
        grasp_dataset = torch.load(os.path.join(self.data_dir, 'new168w.pt' if self.is_downsample else 'Grasp_anyting_shadowhand_downsample.pt'))
