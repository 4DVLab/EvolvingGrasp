...
class Unidexgrasp(Dataset):
    ...
    # read json
    input_file = "/inspurfs/group/mayuexin/datasets/UniDexGrasp/DFCData/grasp.json"
    ...
    def __init__(self, cfg: DictConfig, phase: str, slurm: bool, case_only: bool=False, **kwargs: Dict) -> None:
        ...
        self.data_dir = os.path.join('/inspurfs/group/mayuexin/datasets/UniDexGrasp/DFCData')
        self.scene_path = os.path.join('/inspurfs/group/mayuexin/datasets/UniDexGrasp/DFCData', 'point_cloud_data_10240_nors.pkl')
    ...
    def _pre_load_data(self, case_only: bool) -> None:
        ...
        self.frames = []
        self.scene_pcds = {}
        # grasp_dataset_file = os.path.join(self.data_dir, 'unidexgrasp_shadowhand_downsample.pkl')
        ...
        grasp_dataset = torch.load(os.path.join(self.data_dir, '0.01filter_shadowhand_downsample.pt' if self.is_downsample else 'unidexgrasp_shadowhand_downsample.pt'))
        ...
        if self.use_llm:
            ...
            scene_text_file = "/inspurfs/group/mayuexin/datasets/dex_hand_preprocessed/UniDexGrasp_gpt4o_mini.json"
